#!/usr/bin/env python3
"""Generate REGIONS dict with all ISO country codes"""

# ISO 3166-1 alpha-2 country codes
COUNTRY_CODES = [
    'AF', 'AX', 'AL', 'DZ', 'AS', 'AD', 'AO', 'AI', 'AQ', 'AG', 'AR', 'AM', 'AW', 'AU', 'AT', 'AZ',
    'BS', 'BH', 'BD', 'BB', 'BY', 'BE', 'BZ', 'BJ', 'BM', 'BT', 'BO', 'BQ', 'BA', 'BW', 'BV', 'BR',
    'IO', 'BN', 'BG', 'BF', 'BI', 'KH', 'CM', 'CA', 'CV', 'KY', 'CF', 'TD', 'CL', 'CO', 'KM', 'CG',
    ...
    'HK', 'HU', 'IS', 'ID', 'IR', 'IQ', 'IE', 'IM', 'IL', 'IT', 'JM', 'JE', 'JO', 'KZ', 'KE', 'KI',
    ...
    'TJ', 'TZ', 'TL', 'TG', 'TK', 'TO', 'TT', 'TN', 'TR', 'TM', 'TC', 'TV', 'UG', 'UA', 'AE', 'GB',
...
template = """    '{code}': {{
        ...
        'password': 'large4cats',
        'topic': 'msh/{code}/#',
        'cache_file': 'cache/meshtastic_cache_{code_lower}.json',
        'enabled': True,
        'publish_to_wesense': True
    }},"""

print("# Generated ISO country code regions")
for code in COUNTRY_CODES:
    print(template.format(code=code, code_lower=code.lower()))
